...
namespace TFlex.DOCs.References.MDM.Rank
{
	...
	/// </summary>
	public partial class RankMDMReferenceObject
	{
		
		internal RankMDMReferenceObject(RankMDMReference reference) : 
				base(reference)
		{
		}
		...
		/// </summary>
		public new RankMDMType Class
		{
			get
			{
				return ((RankMDMType)(base.Class));
			}
		}
		...
		public class FieldKeys
		{
		   ...
		   public static readonly Guid Name = new Guid("9a3d2d23-f6e6-403c-8380-0d99c890218e");
			...
			/// </summary>
		   public static readonly Guid Kod = new Guid("1453cff1-7aaa-4558-90c9-35057360e30b");
